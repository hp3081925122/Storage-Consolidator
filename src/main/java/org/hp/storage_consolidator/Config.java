...
@Mod.EventBusSubscriber(modid = Storage_consolidator.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public final class Config {
    /** 配置构建器。 */
    private static final ForgeConfigSpec.Builder BUILDER = new ForgeConfigSpec.Builder();
    /** 默认跳过的网络仓储模组。 */
    private static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> BLOCKED_SOURCE_MOD_IDS =
            BUILDER.comment(
                    "默认排除 Refined Storage 和 AE2 这类网络仓储，其他可解析库存来源默认启用。",
                    "如需额外跳过某个模组，将其模组 ID 写入 blockedSourceModIds；删除默认 ID 可重新启用对应来源。"
            ).defineListAllowEmpty("blockedSourceModIds", java.util.List.of("refinedstorage", "ae2"), Config::isValidModId);
    /** 是否跳过无法定位方块的库存来源。 */
    private static final ForgeConfigSpec.BooleanValue SKIP_UNKNOWN_SOURCES =
            BUILDER.comment(
                    "无法解析到真实方块位置的库存是否跳过。开启可以避免处理未知的虚拟库存。",
                    "Whether to skip inventories whose real block position cannot be resolved."
